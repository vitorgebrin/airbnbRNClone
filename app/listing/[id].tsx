...
const Page = () => {
    ...
    //Animation for the Parallax
    //here the applied useAnimatedRef is to match the Animated ScrollView
...
//End of Parallax Animation

//Use of useNavigation to change the styles of the navigation from Expo
const navigation = useNavigation()
const sharedListingButton = async () => {
  try{
    await Share.share({
      title:listing.name,
...
const headerAnimatedStyle = useAnimatedStyle(()=> {
  return { opacity:interpolate(scrollOffset.value,[0,IMG_HEIGHT/1.5],[0,1])}
})
...
<View style={styles.container}>
  ...
  scrollEventThrottle={16}>
    <Animated.Image source={{uri:listing.xl_picture_url}} style={[styles.image,imageAnimatedStyle]}></Animated.Image>
